...
INSERT INTO FIGURINE(ID,NAME, DESCRIPTION, SIZE, PRICE) VALUES
(1,"Aerith", "Aerith Gainsborough est la dernière descendante des Cetras (ou Anciens), fille du professeur Gast et d'Ifalna",35,24.99),
(2,"Barret", "Barret Wallaceest le chef d'AVALANCHE, groupe écologiste de résistance à l'épuisement des ressources planétaires (l'énergie Mako) par la Shinra.",30,24.99),
(3,"Cloud", "Cloud Strife est le principal héros de Final Fantasy VII. Convaincu d'être un ancien SOLDAT, il est au début du jeu un mercenaire employé par AVALANCHE.",37,34.99),
(4,"Nanaki", "Rouge XIII, de son vrai nom Nanaki, est l'un des derniers survivants de sa tribu, composée de personnages proches des félidés (lion, tigre, jaguar, ...) par leur aspect physique, vivant à Cosmo Canyon.",25,24.99),
(5,"Sephiroth", "Sephiroth est présenté au cours du jeu comme le fils de Hojo, un savant fou, et de Lucrécia, son assistante.",35,34.99),
(6,"Tifa", "Tifa Lockheart est une jeune femme originaire de Nibelheim, amie d'enfance de Cloud et membre du groupe AVALANCHE",35,24.99);
...
CREATE TABLE FIGURINE_CATEGORY (
  FIGURINE_ID INT NOT NULL,
  CATGORY_ID INT NOT NULL
);

INSERT INTO FIGURINE_CATEGORY VALUES
(1,1),
(2,1),
(3,1),
(4,1),
